param(
    # Source folder containing the original brasões – same directory as this script
...
# Mapping list: each entry contains possible substrings (lower‑case, accent‑free) and the ISO country code.
$maps = @(
