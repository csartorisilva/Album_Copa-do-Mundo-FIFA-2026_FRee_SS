param(
    # Absolute source folder containing the original brasões
    [string]$sourcePath = "C:\\Users\\M173150\\OneDrive - MerckGroup\\Particular\\album-fifa-2026\\Brasões",
    # Destination folder inside the project (relative to script location for portability)
...
# Mapping list: substrings (lowercase, accent‑free) → ISO country code
$maps = @(
